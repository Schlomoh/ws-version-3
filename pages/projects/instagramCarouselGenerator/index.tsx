...
import { BaseProjectPage, TextWrapper } from "../../../components";
  ...
  return (
    <BaseProjectPage>
      ...
      <TextWrapper underline>
        ...
        <p>
          When I set out to build the Instagram Carousel Post Generator, I
          wanted to use a tech stack that would make development smooth and
          efficient. Here's a list of the technologies that played a significant
          role in the project:
        </p>
        <ul>
          <li>
          ...
          <li>
            <p>
              <strong>Framer Motion: </strong>To create delightful UI
              animations, I chose Framer Motion, a popular animation library.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          ability to generate engaging and well-written content. By leveraging
          the capabilities of this powerful language model, I was able to create
          carousel posts that resonated with the target audience and encouraged
          engagement.
        </p>
        <h2>The development process 🛠️</h2>
        <p>
          Building the Instagram Carousel Post Generator was an iterative
          process. I started by designing an interactive user interface that
          gathered information through a series of prompts. This helped tailor
          the generated content to the user's specific needs. I then
          incorporated p5-react to create dynamic carousel previews, making it
          easy for users to visualize the final result and make adjustments as
          needed.
        </p>
        <h2>Bringing it all together 🎨</h2>
        <p>
          To make the tool even more user-friendly, I added the ability to
          export and modify the generated carousel posts, giving users the
          freedom to further customize their content. Framer Motion enhanced the
          overall user experience with smooth and visually appealing animations.
        </p>
        <h2>Sharing my journey on twitter 🐦</h2>
        <p>
          Throughout this development journey, I documented my progress and
          shared it on Twitter. Check out the thread below to see how the
          project unfolded:
        </p>
        <div
          style={{
        ...
        <p>
          ...
          experience that has not only honed my programming skills but also
          taught me valuable lessons about creating engaging content. It's been
          a fascinating journey, and I'm proud of the final product, which I
          believe will help many content creators streamline their social media
          marketing efforts.
        </p>
        <p>
          I'm grateful to have had the opportunity to explore various
          cutting-edge technologies that have made the development process
          enjoyable and efficient. As I continue to work on and improve the
          Instagram Carousel Post Generator, I look forward to incorporating
          user feedback and discovering new ways to make the tool even better.
        </p>
        <p>
        ...
        <p>
          If you'd like to try the Instagram Carousel Post Generator for
          yourself, be sure to check it out{" "}
          <Link href="https://insta-carousel-generator.vercel.app/">here</Link>.
